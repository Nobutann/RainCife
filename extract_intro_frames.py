"""
extract_intro_frames.py
-----------------------
Extracts frames from assets/sprites/Intro.mp4 into assets/sprites/intro_frames/
at 30 fps using OpenCV or pyav or ffmpeg subprocess.

Run from the project root:  python extract_intro_frames.py
"""
...
INPUT  = os.path.join("assets", "sprites", "Intro.mp4")
OUTDIR = os.path.join("assets", "sprites", "intro_frames")
FPS    = 30
